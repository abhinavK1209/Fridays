export const products = [
  {
    ...
    bottleGradient: 'linear-gradient(160deg, #1a1008 0%, #3d2208 35%, #6b3a10 55%, #2a1505 100%)',
    glowColor: 'rgba(223,140,60,0.55)',
    accentColor: '#df9550',
    badge: 'Bestseller',
    featured: true,
  },
  {
    ...
    bottleGradient: 'linear-gradient(160deg, #0d1117 0%, #1c2a3a 35%, #2e4260 55%, #111820 100%)',
  ...
  },
  {
    ...
    bottleGradient: 'linear-gradient(160deg, #1e0a0a 0%, #4a1818 35%, #7a2828 55%, #2e1010 100%)',
    glowColor: 'rgba(220,100,80,0.55)',
    accentColor: '#e87060',
    badge: null,
    featured: true,
  },
  {
    ...
    bottleGradient: 'linear-gradient(160deg, #0e0a1a 0%, #281848 35%, #3e2468 55%, #1a1030 100%)',
    glowColor: 'rgba(160,100,240,0.55)',
    accentColor: '#a064f0',
    badge: null,
    featured: false,
  },
  {
    ...
    bottleGradient: 'linear-gradient(160deg, #061410 0%, #0e2e20 35%, #1a4e38 55%, #0a2018 100%)',
    glowColor: 'rgba(60,200,140,0.5)',
    accentColor: '#3cc88a',
    badge: 'Travel Size',
    featured: false,
  },
  {
    ...
    bottleGradient: 'linear-gradient(160deg, #1c1208 0%, #3e2810 35%, #6a4418 55%, #2c1e0a 100%)',
    glowColor: 'rgba(223,169,80,0.6)',
    accentColor: '#f0b84a',
    badge: 'Kit',
    featured: false,
  },
