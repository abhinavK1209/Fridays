export const products = [
  {
    ...
    bottleGradient: 'linear-gradient(160deg, #3d1c05 0%, #8b4510 30%, #c07020 55%, #6b3010 80%, #2a1205 100%)',
    glowColor: 'rgba(223,140,60,0.7)',
    accentColor: '#df9550',
    badge: 'Bestseller',
    featured: true,
  },
  {
    ...
    bottleGradient: 'linear-gradient(160deg, #0a1525 0%, #1a3555 30%, #2a5585 55%, #183050 80%, #0d1e35 100%)',
  ...
  },
  {
    ...
    bottleGradient: 'linear-gradient(160deg, #300808 0%, #7a1a1a 30%, #b83535 55%, #8a2020 80%, #3d0f0f 100%)',
    glowColor: 'rgba(220,80,60,0.7)',
    accentColor: '#e05040',
    badge: null,
    featured: true,
  },
